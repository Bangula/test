...
const LogosSections = ({ sections, object, toggleManageSection }) => {
    ...
    return (
      <section key={section.id} className="mb-8">
        <div className="flex items-center justify-between mb-5 px-4">
          ...
          <div>
            <button
              onClick={() => toggleManageSection(object)}
              className="uppercase text-white border rounded border-pink px-5 pb-1 pt-2 tracking-wide text-xl">
              Manage section
            </button>
